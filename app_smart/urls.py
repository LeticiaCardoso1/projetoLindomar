...
from . import views
from app_smart.api.viewsets import CreateUserAPIViewSet, SensorViewSet, SensorFilterView, TemperaturaDataViewSet, ContadorDataViewSet, UmidadeDataViewSet, LuminosidadeDataViewSet
